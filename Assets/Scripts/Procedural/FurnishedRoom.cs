...
namespace Procedural
{
    public class FurnishedRoom
    {
        ...
        public FurnishedRoom(List<(Vector3Int, int)> doors, Dictionary<Vector3Int, TileBase> tiles, Dictionary<Vector3Int, TileBase> floorTiles, Dictionary<Vector3Int, GameObject> props, int width, int height)
        {
            Doors = doors;
            Tiles = tiles;
            Props = props;
